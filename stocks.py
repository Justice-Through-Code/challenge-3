...
def stock_purchases():
    ...
    # 1.1 TODO: Ask the client's name and save it into a variable

    # 1.2 TODO: Ask the client how many dollars they would like to invest and save it into a variable
    ...
    # NOTE: When use use the `input` function to get user input, what do numbers get saved as?
